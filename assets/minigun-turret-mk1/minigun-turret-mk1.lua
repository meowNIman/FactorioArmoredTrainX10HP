...
return
{
	filename = "__Armored-train__/assets/minigun-turret-mk1/sprites/minigun-turret-raising.png",
	priority = "medium",
	width = 130,
	height = 126,
	direction_count = 4,
	...
	{
		{
			...
			{
				{
					filename = "__Armored-train__/assets/minigun-turret-mk1/sprites/minigun-turret-shooting-1.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train__/assets/minigun-turret-mk1/sprites/minigun-turret-shooting-2.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train__/assets/minigun-turret-mk1/sprites/minigun-turret-shooting-3.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-train__/assets/minigun-turret-mk1/sprites/minigun-turret-shooting-4.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				}
			}
