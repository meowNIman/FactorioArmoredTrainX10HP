...
-- HP 
l_rocket_turret_mk1.max_health = 10000			-- Same as platform hp (Critical component or will be destroyed using old script)
-- Resistance copy
...
return
{
	filename = "__Armored-trainX10HP__/assets/rocket-turret-mk1/sprites/rocket-turret-raising.png",
	priority = "medium",
	width = 88,
	height = 80,
	direction_count = 4,
	...
	{
		{
			...
			{
				{
					filename = "__Armored-trainX10HP__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-1.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-2.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-3.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/rocket-turret-mk1/sprites/rocket-turret-shooting-4.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				}
			}
