...
({
	{
		...
		icon = "__Armored-trainX10HP__/assets/minigun-platform-mk1/minigun-platform-mk1-icon.png",
...
l_minigun_platform_mk1.icon = "__Armored-trainX10HP__/assets/minigun-platform-mk1/minigun-platform-mk1-icon.png"
	...
	{
		{
			...
			filenames =
			{
				"__Armored-trainX10HP__/assets/minigun-platform-mk1/sprites/platform-mk1-01.png",
				"__Armored-trainX10HP__/assets/minigun-platform-mk1/sprites/platform-mk1-02.png",
				"__Armored-trainX10HP__/assets/minigun-platform-mk1/sprites/platform-mk1-03.png",
				"__Armored-trainX10HP__/assets/minigun-platform-mk1/sprites/platform-mk1-04.png"
			}
		}
	}
}
...
{
	filename = "__Armored-trainX10HP__/assets/minigun-platform-mk1/minigun-platform-mk1-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
...
{
	filename = "__Armored-trainX10HP__/assets/minigun-platform-mk1/minigun-platform-mk1-selected-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
