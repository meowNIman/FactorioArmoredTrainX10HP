...
-- HP 
l_cannon_turret_mk1.max_health = 10000			-- Same as platform hp (Critical component or will be destroyed using old script)
-- Resistance copy
...
return
{
	filename = "__Armored-trainX10HP__/assets/cannon-turret-mk1/sprites/cannon-turret-raising.png",
	priority = "medium",
	width = 179,
	height = 132,
	direction_count = 4,
	...
	{
		{
			...
			{
				{
					filename = "__Armored-trainX10HP__/assets/cannon-turret-mk1/sprites/cannon-turret-shooting-1.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/cannon-turret-mk1/sprites/cannon-turret-shooting-2.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/cannon-turret-mk1/sprites/cannon-turret-shooting-3.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				},
				{
					filename = "__Armored-trainX10HP__/assets/cannon-turret-mk1/sprites/cannon-turret-shooting-4.png",
					width_in_frames = inputs.frame_count or 2,
					height_in_frames = 16
				}
			}
...
local blank_layers = 
{
	...
	{
		{
			filename = 	"__Armored-trainX10HP__/assets/minigun-turret-mk1/fakeTransparent.png",
			direction_count = 1,
			height = 16,
			width = 16
		}
