...
({
	{
		...
		icon = "__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/flamethrower-wagon-mk1-icon.png",
...
l_flamethrower_platform_mk1.icon = "__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/flamethrower-wagon-mk1-icon.png"
...
l_flamethrower_platform_mk1.max_health = 10000					-- Same as turret hp (Critical component or will be destroyed using old script)	
	...
	{
		{
			...
			filenames =
			{
				"__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/sprites/wagon-mk1-01.png",
				"__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/sprites/wagon-mk1-02.png",
				"__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/sprites/wagon-mk1-03.png",
				"__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/sprites/wagon-mk1-04.png"
			}
		}
	}
}
...
{
	filename = "__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/flamethrower-wagon-mk1-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
...
{
	filename = "__Armored-trainX10HP__/assets/flamethrower-wagon-mk1/flamethrower-wagon-mk1-selected-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
