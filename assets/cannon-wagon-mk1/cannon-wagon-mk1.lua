...
({
	{
		type = "item",
		name = "cannon-wagon-mk1",
		icon = "__Armored-trainX10HP__/assets/cannon-wagon-mk1/cannon-wagon-mk1-icon.png",
		icon_size = 64, icon_mipmaps = 4,
		subgroup = "transport",
		order = "a[train-system]-l[wagon_mk1_00]",
		place_result = "cannon-wagon-mk1",
		stack_size = 5
	}
})
...
l_minigun_platform_mk1.name = "cannon-wagon-mk1"
l_minigun_platform_mk1.icon = "__Armored-trainX10HP__/assets/cannon-wagon-mk1/cannon-wagon-mk1-icon.png"
	...
	{
		{
			...
			filenames =
			{
				"__Armored-trainX10HP__/assets/cannon-wagon-mk1/sprites/wagon-mk1-01.png",
				"__Armored-trainX10HP__/assets/cannon-wagon-mk1/sprites/wagon-mk1-02.png",
				"__Armored-trainX10HP__/assets/cannon-wagon-mk1/sprites/wagon-mk1-03.png",
				"__Armored-trainX10HP__/assets/cannon-wagon-mk1/sprites/wagon-mk1-04.png"
			}
		}
	}
}
...
{
	filename = "__Armored-trainX10HP__/assets/cannon-wagon-mk1/cannon-wagon-mk1-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
...
{
	filename = "__Armored-trainX10HP__/assets/cannon-wagon-mk1/cannon-wagon-mk1-selected-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
