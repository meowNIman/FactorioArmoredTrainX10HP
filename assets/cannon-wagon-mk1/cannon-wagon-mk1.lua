...
({
	{
		...
		icon = "__Armored-train__/assets/cannon-wagon-mk1/cannon-wagon-mk1-icon.png",
...
l_minigun_platform_mk1.icon = "__Armored-train__/assets/cannon-wagon-mk1/cannon-wagon-mk1-icon.png"
	...
	{
		{
			...
			filenames =
			{
				"__Armored-train__/assets/cannon-wagon-mk1/sprites/wagon-mk1-01.png",
				"__Armored-train__/assets/cannon-wagon-mk1/sprites/wagon-mk1-02.png",
				"__Armored-train__/assets/cannon-wagon-mk1/sprites/wagon-mk1-03.png",
				"__Armored-train__/assets/cannon-wagon-mk1/sprites/wagon-mk1-04.png"
			}
		}
	}
}
...
{
	filename = "__Armored-train__/assets/cannon-wagon-mk1/cannon-wagon-mk1-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
...
{
	filename = "__Armored-train__/assets/cannon-wagon-mk1/cannon-wagon-mk1-selected-minimap-representation.png",
	flags = {"icon"},
	size = {20, 40},
	scale = 0.5
}
